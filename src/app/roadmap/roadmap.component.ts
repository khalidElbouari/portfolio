...
export class RoadmapComponent {
  ...
  education = [
    { title: 'Master Qualité du Logiciel (MQL)', details: 'Faculté des Sciences Dhar El Mahraz', date: 'En cours' },
    ...
    { title: 'High School Diploma in Physics', details: '\tAl Masira Al Khadra', date: '2021' },
